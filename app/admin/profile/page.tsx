  ...
  return (
    <>
      <style>{`
        ...
        .ap-orb-1 { width:420px; height:420px; top:-180px; right:8%; background:radial-gradient(circle, rgba(21,94,239,.13), transparent 70%); animation:oFloat 9s ease-in-out infinite; }
        ...
        .ap-cover-btn {
          ...
          color:#8fb4ff; cursor:pointer;
          transition:background .2s, border-color .2s, box-shadow .2s;
        }
        .ap-cover-btn:hover { background:rgba(21,94,239,.18); border-color:rgba(21,94,239,.5); box-shadow:0 0 20px rgba(21,94,239,.15); }
        ...
        .ap-av-init { font-family:'Cormorant',serif; font-size:46px; font-weight:300; font-style:italic; color:#8fb4ff; }
        .ap-av-ov {
        ...
        .ap-av-ov svg { width:22px; height:22px; stroke:#8fb4ff; fill:none; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; }
        .ap-av-ov-t { font-size:9px; font-weight:800; letter-spacing:.12em; text-transform:uppercase; color:#8fb4ff; }

        /* meta */
        .ap-meta { flex:1; min-width:0; padding-bottom:10px; }
        .ap-meta-ey {
          font-size:9px; font-weight:800; letter-spacing:.24em; text-transform:uppercase; color:#8fb4ff;
          display:flex; align-items:center; gap:10px; margin-bottom:7px;
          opacity:0; animation:fUp .55s .15s forwards;
        }
        .ap-meta-ey::before { content:''; width:28px; height:1px; background:#8fb4ff; display:block; }
        .ap-meta-name {
        ...
        .ap-meta-role::before { content:''; width:5px; height:5px; border-radius:50%; background:#8fb4ff; animation:bPulse 2s infinite; }
        ...
        .ap-btn-g:hover { border-color:rgba(21,94,239,.4); color:#8fb4ff; background:rgba(21,94,239,.06); }
        .ap-btn-gold {
          background:linear-gradient(135deg,#0f49c4 0%,#155EEF 50%,#0f49c4 100%);
          background-size:200% 100%; background-position:0 0;
          color:#ffffff; border:none; border-radius:10px;
          padding:.55rem 1.35rem; font-family:'Syne',sans-serif; font-size:11px; font-weight:800;
          letter-spacing:.1em; text-transform:uppercase; cursor:pointer;
          box-shadow:0 4px 22px rgba(21,94,239,.3); transition:all .3s; white-space:nowrap;
        }
        .ap-btn-gold:hover { background-position:100% 0; box-shadow:0 6px 32px rgba(21,94,239,.55); transform:translateY(-2px); }
        ...
        .ap-tab.on { color:#8fb4ff; }
        .ap-tab.on::after {
          content:''; position:absolute; bottom:-1px; left:0; right:0; height:2px;
          background:linear-gradient(90deg,transparent,#8fb4ff,transparent);
        }
        ...
        .ap-sl span { font-size:9px; font-weight:800; letter-spacing:.22em; text-transform:uppercase; color:#8fb4ff; white-space:nowrap; }
        ...
        .ap-ic:hover { transform:translateY(-4px); border-color:rgba(21,94,239,.2); box-shadow:0 16px 50px rgba(0,0,0,.5),0 0 0 1px rgba(21,94,239,.08); }
        .ap-ic:hover::before { opacity:1; }
        .ap-ic-sym { font-size:20px; color:#8fb4ff; margin-bottom:12px; opacity:.6; }
        ...
        .ap-ic-val { font-size:15px; font-weight:600; color:#e9eef8; word-break:break-word; line-height:1.4; }
        ...
        .ap-bio:hover { border-color:rgba(21,94,239,.18); }
        .ap-bio-deco {
          position:absolute; top:12px; right:24px;
          font-family:'Cormorant',serif; font-size:100px; font-weight:300; font-style:italic;
          color:rgba(21,94,239,.05); line-height:1; pointer-events:none; user-select:none;
        }
        .ap-bio-lbl { font-size:9px; font-weight:800; letter-spacing:.2em; text-transform:uppercase; color:#8fb4ff; margin-bottom:16px; }
        ...
        .ap-fw::before {
          ...
          height:1px; background:linear-gradient(90deg,transparent,rgba(21,94,239,.45),transparent);
        }
        .ap-ft { font-family:'Cormorant',serif; font-size:40px; font-weight:300; font-style:italic; color:#e9eef8; margin-bottom:36px; letter-spacing:-.01em; }
        .ap-ft em { color:#8fb4ff; font-style:italic; }
        ...
        .ap-fi:focus { border-color:rgba(21,94,239,.45); background:rgba(21,94,239,.04); box-shadow:0 0 0 4px rgba(21,94,239,.08),inset 0 1px 0 rgba(21,94,239,.1); }
        .ap-fl {
        ...
        .ap-fsec { font-size:9px; font-weight:800; letter-spacing:.2em; text-transform:uppercase; color:#8fb4ff; margin:30px 0 16px; display:flex; align-items:center; gap:12px; }
