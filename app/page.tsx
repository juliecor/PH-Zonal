                  ...
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-transparent bg-[#ffffff] px-10 py-3 text-sm text-white placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-white/50"
                      />
                      {regionSearch && (
                        <button
