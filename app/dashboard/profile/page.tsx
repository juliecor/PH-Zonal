      ...
      <style>{`
        ...
        .cp-aurora {
          ...
          background:
            ...
            radial-gradient(ellipse 65% 45% at 85% 25%, rgba(21,94,239,.22) 0%, transparent 52%),
            radial-gradient(ellipse 55% 65% at 65% 85%, rgba(20,45,90,.7)  0%, transparent 50%),
            radial-gradient(ellipse 80% 35% at 5%  90%, rgba(21,94,239,.07) 0%, transparent 45%);
        ...
        .cp-orb-1 { width:420px; height:420px; top:-180px; right:8%; background:radial-gradient(circle,rgba(21,94,239,.13),transparent 70%); animation:coFloat 9s ease-in-out infinite; }
        ...
        .cp-cover-btn {
          ...
          padding:.38rem .9rem;
          background:rgba(21,94,239,.09); border:1px solid rgba(21,94,239,.22); border-radius:999px;
          backdrop-filter:blur(14px); font-family:'Syne',sans-serif;
          font-size:10px; font-weight:700; letter-spacing:.14em; text-transform:uppercase;
          color:#8fb4ff; cursor:pointer; transition:background .2s,border-color .2s,box-shadow .2s;
        }
        .cp-cover-btn:hover { background:rgba(21,94,239,.18); border-color:rgba(21,94,239,.5); box-shadow:0 0 20px rgba(21,94,239,.15); }
        ...
        .cp-av-ring {
          ...
          background:conic-gradient(from 0deg,#8fb4ff 0%,#8fb4ff 30%,#fff9ee 50%,#8fb4ff 70%,#8fb4ff 100%);
        ...
        .cp-av-init { font-family:'Cormorant',serif; font-size:46px; font-weight:300; font-style:italic; color:#8fb4ff; }
        .cp-av-ov {
        ...
        .cp-av-ov svg { width:22px; height:22px; stroke:#8fb4ff; fill:none; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; }
        .cp-av-ov-t { font-size:9px; font-weight:800; letter-spacing:.12em; text-transform:uppercase; color:#8fb4ff; }

        /* meta */
        .cp-meta { flex:1; min-width:0; padding-bottom:10px; }
        .cp-meta-ey { font-size:9px; font-weight:800; letter-spacing:.24em; text-transform:uppercase; color:#8fb4ff; display:flex; align-items:center; gap:10px; margin-bottom:7px; opacity:0; animation:cfUp .55s .15s forwards; }
        .cp-meta-ey::before { content:''; width:28px; height:1px; background:#8fb4ff; display:block; }
        .cp-meta-name {
          font-family:'Cormorant',serif; font-size:clamp(30px,5vw,56px); font-weight:300; font-style:italic;
          color:#e9eef8; line-height:1.05; letter-spacing:-.02em;
        ...
        .cp-meta-role {
          ...
          padding:.24rem .75rem;
          background:rgba(21,94,239,.08); border:1px solid rgba(21,94,239,.28); border-radius:999px;
          font-size:9px; font-weight:800; letter-spacing:.16em; text-transform:uppercase; color:#8fb4ff;
        }
        .cp-meta-role::before { content:''; width:5px; height:5px; border-radius:50%; background:#8fb4ff; animation:cpBlink 2s infinite; }
        ...
        .cp-btn-g:hover { border-color:rgba(21,94,239,.4); color:#8fb4ff; background:rgba(21,94,239,.06); }
        .cp-btn-gold {
          background:linear-gradient(135deg,#0f49c4 0%,#155EEF 50%,#0f49c4 100%); background-size:200% 100%; background-position:0 0;
          color:#ffffff; border:none; border-radius:10px; padding:.55rem 1.35rem;
          font-family:'Syne',sans-serif; font-size:11px; font-weight:800; letter-spacing:.1em; text-transform:uppercase;
          cursor:pointer; box-shadow:0 4px 22px rgba(21,94,239,.3); transition:all .3s; white-space:nowrap;
        }
        .cp-btn-gold:hover { background-position:100% 0; box-shadow:0 6px 32px rgba(21,94,239,.55); transform:translateY(-2px); }
        ...
        .cp-tab.on { color:#8fb4ff; }
        .cp-tab.on::after { content:''; position:absolute; bottom:-1px; left:0; right:0; height:2px; background:linear-gradient(90deg,transparent,#8fb4ff,transparent); }
        ...
        .cp-sl span { font-size:9px; font-weight:800; letter-spacing:.22em; text-transform:uppercase; color:#8fb4ff; white-space:nowrap; }
        ...
        .cp-token-hero {
          ...
          box-shadow:0 20px 60px rgba(0,0,0,.6), inset 0 1px 0 rgba(21,94,239,.08);
        ...
        .cp-token-hero::before {
          ...
          height:1px; background:linear-gradient(90deg,transparent,rgba(21,94,239,.5),transparent);
        }
        .cp-token-hero-bg {
          position:absolute; inset:0; pointer-events:none;
          background:radial-gradient(ellipse 80% 100% at 80% 50%, rgba(21,94,239,.06) 0%, transparent 60%);
        }
        .cp-token-hero-grid {
          position:absolute; inset:0; pointer-events:none;
          background-image:linear-gradient(rgba(21,94,239,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(21,94,239,.025) 1px,transparent 1px);
          background-size:40px 40px;
        }
        .cp-token-hero-left { position:relative; z-index:2; }
        .cp-token-hero-lbl { font-size:9px; font-weight:800; letter-spacing:.22em; text-transform:uppercase; color:rgba(21,94,239,.6); margin-bottom:10px; }
        .cp-token-hero-val {
          font-family:'Cormorant',serif; font-size:clamp(40px,7vw,72px); font-weight:300; font-style:italic;
          color:#8fb4ff; line-height:1; letter-spacing:-.02em;
        }
        ...
        .cp-token-icon {
          ...
          background:rgba(21,94,239,.1); border:1px solid rgba(21,94,239,.2);
          display:flex; align-items:center; justify-content:center;
          font-size:32px;
          box-shadow:0 0 40px rgba(21,94,239,.15);
          animation:coinGlow 3s ease-in-out infinite alternate;
        }
        @keyframes coinGlow {
          from { box-shadow:0 0 20px rgba(21,94,239,.12); }
          to   { box-shadow:0 0 50px rgba(21,94,239,.3), 0 0 80px rgba(21,94,239,.1); }
        }
        ...
        .cp-ic::before {
          ...
          background:linear-gradient(90deg,transparent,rgba(21,94,239,.25),transparent);
          opacity:0; transition:opacity .25s;
        }
        .cp-ic:hover { transform:translateY(-4px); border-color:rgba(21,94,239,.2); box-shadow:0 16px 50px rgba(0,0,0,.5),0 0 0 1px rgba(21,94,239,.08); }
        .cp-ic:hover::before { opacity:1; }
        .cp-ic-sym { font-size:20px; color:#8fb4ff; margin-bottom:12px; opacity:.6; }
        ...
        .cp-ic-val { font-size:15px; font-weight:600; color:#e9eef8; word-break:break-word; line-height:1.4; }
        ...
        .cp-bio:hover { border-color:rgba(21,94,239,.18); }
        .cp-bio-deco { position:absolute; top:12px; right:24px; font-family:'Cormorant',serif; font-size:100px; font-weight:300; font-style:italic; color:rgba(21,94,239,.05); line-height:1; pointer-events:none; user-select:none; }
        .cp-bio-lbl { font-size:9px; font-weight:800; letter-spacing:.2em; text-transform:uppercase; color:#8fb4ff; margin-bottom:16px; }
        ...
        .cp-fw::before { content:''; position:absolute; top:-1px; left:8%; right:8%; height:1px; background:linear-gradient(90deg,transparent,rgba(21,94,239,.45),transparent); }
        .cp-ft { font-family:'Cormorant',serif; font-size:40px; font-weight:300; font-style:italic; color:#e9eef8; margin-bottom:36px; letter-spacing:-.01em; }
        .cp-ft em { color:#8fb4ff; font-style:italic; }
        ...
        .cp-fi {
          ...
          font-family:'Syne',sans-serif; font-size:14px; font-weight:500; color:#e9eef8;
          outline:none; transition:border-color .25s,background .25s,box-shadow .25s; caret-color:#8fb4ff;
        }
        .cp-fi::placeholder { color:transparent; }
        .cp-fi:focus { border-color:rgba(21,94,239,.45); background:rgba(21,94,239,.04); box-shadow:0 0 0 4px rgba(21,94,239,.08),inset 0 1px 0 rgba(21,94,239,.1); }
        .cp-fl {
        ...
        .cp-fi:not(:placeholder-shown) + .cp-fl {
          ...
          color:#8fb4ff; font-weight:800; background:#0f1a2e; padding:0 6px;
        }
        ...
        .cp-fsec { font-size:9px; font-weight:800; letter-spacing:.2em; text-transform:uppercase; color:#8fb4ff; margin:30px 0 16px; display:flex; align-items:center; gap:12px; }
